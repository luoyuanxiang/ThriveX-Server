...
public class OssUtils {
    ...
    public static void setPlatformToDefault(OssEntity oss) {
        // 获取存储平台 List
     ...
     * @param oss
     */
    public static void setHuaweiConfig(OssEntity oss) {
        // 获得存储平台 List
        CopyOnWriteArrayList<FileStorage> list = fileStorageService.getFileStorageList();
     ...
     * 将阿里云配置信息设置到存储平台
     */
    public static void setAliyunConfig(OssEntity oss) {
        CopyOnWriteArrayList<FileStorage> list = fileStorageService.getFileStorageList();
     ...
     * 将千牛云配置信息设置到存储平台
     */
    public static void setQiniuConfig(OssEntity oss) {
        CopyOnWriteArrayList<FileStorage> list = fileStorageService.getFileStorageList();
     ...
     * 将腾讯云配置信息设置到存储平台
     */
    public static void setTencentConfig(OssEntity oss) {
        CopyOnWriteArrayList<FileStorage> list = fileStorageService.getFileStorageList();
     ...
     * 将minio配置信息设置到存储平台
     */
    public static void setMinioConfig(OssEntity oss) {
        CopyOnWriteArrayList<FileStorage> list = fileStorageService.getFileStorageList();
    ...
    // 加载指定的平台
    public static void registerPlatform(OssEntity oss) {
