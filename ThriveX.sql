...
/*!40000 ALTER TABLE `album_cate`
    DISABLE KEYS */;
INSERT INTO `album_cate`
VALUES (1, '旅行',
...
/*!40000 ALTER TABLE `album_image`
    DISABLE KEYS */;
INSERT INTO `album_image`
VALUES (1, '日本富士山', '日本标志性的富士山风景,白雪皑皑的山顶与蓝天相映成趣',
        'https://images.unsplash.com/photo-1480796927426-f609979314bd?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (2, '日落时分', '夕阳西下的美丽景色,金色的阳光洒在大地上',
        'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (3, '山川湖泊', '壮丽的山川与平静的湖泊交相辉映,展现大自然的鬼斧神工',
        'https://images.unsplash.com/photo-1501785888041-af3ef285b470?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (4, '星空璀璨', '繁星点点的夜空,银河横跨天际,令人沉醉的夜景',
        'https://images.unsplash.com/photo-1441716844725-09cedc13a4e7?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (5, '绿色山谷', '郁郁葱葱的山谷,清新的空气与翠绿的植被构成和谐画面',
        'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (6, '京都古寺', '日本京都的传统寺庙,展现着东方古典建筑的独特魅力',
        'https://images.unsplash.com/photo-1542051841857-5f90071e7989?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (7, '城市夜景', '灯火通明的现代都市,霓虹闪烁的夜晚风景',
        'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (8, '海边日落', '金色的夕阳映照在海面上,浪花轻轻拍打着沙滩',
        'https://images.unsplash.com/photo-1504198322253-cfa87a0ff25f?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (9, '樱花季节', '粉色的樱花绽放,营造出浪漫唯美的春日氛围',
        'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (10, '繁华都市', '现代化的城市景观,高楼大厦鳞次栉比',
        'https://images.unsplash.com/photo-1503614472-8c93d56e92ce?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100', 1,
        '1729224230508'),
       (11, '雪山之巅', '巍峨的雪山山峰,白雪皑皑,云雾缭绕',
        'https://images.unsplash.com/photo-1444464666168-49d633b86797?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (13, '街头巷尾', '充满生活气息的街道,记录着城市的日常点滴',
        'https://images.unsplash.com/photo-1492571350019-22de08371fd3?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (14, '晨光熹微', '清晨的第一缕阳光,唤醒沉睡的大地',
        'https://images.unsplash.com/photo-1494548162494-384bba4ab999?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (15, '极光之夜', '绚丽的北极光在夜空中舞动,创造出梦幻般的景象',
        'https://images.unsplash.com/photo-1504714146340-959ca07e1f38?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508'),
       (16, '山水如画', '如诗如画的山水风景,展现大自然的壮美与和谐',
        'https://images.unsplash.com/photo-1501785888041-af3ef285b470?ixlib=rb-1.2.1&auto=format&fit=crop&w=3840&q=100',
        1, '1729224230508');
/*!40000 ALTER TABLE `album_image`
    ENABLE KEYS */;
...
/*!40000 ALTER TABLE `article`
    DISABLE KEYS */;
INSERT INTO `article`
VALUES (1, 'Hello World', '当你看到这篇文章时就意味着安装成功，一切就绪！',
        '当你看到这篇文章时就意味着安装成功，一切就绪！\n', NULL, 9, 0, '1729224230508'),
       (2, '🎉 ThriveX 现代化博客管理系统',
        'ThriveX 是一个简而不简单的现代化博客管理系统，专注于分享技术文章和知识，为技术爱好者和从业者提供一个分享、交流和学习的平台。用户可以在平台上发表自己的技术文章，或浏览其他用户分享的文章，并与他们进行讨论和互动。',
...
(
  ...
  AUTO_INCREMENT = 1472
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='文章和分类的中间表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  AUTO_INCREMENT = 15
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='文章配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `article_config`
    DISABLE KEYS */;
INSERT INTO `article_config`
VALUES (1, 'default', '', 0, 0, 0, 1),
       (2, 'default', '', 0, 0, 0, 2),
       (14, 'default', '', 0, 0, 0, 5);
/*!40000 ALTER TABLE `article_config`
    ENABLE KEYS */;
...
(
  ...
  AUTO_INCREMENT = 5
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='助手管理';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `assistant`
    DISABLE KEYS */;
INSERT INTO `assistant`
VALUES (2, '测试助手', 'xxxxxxxxxxxxxxxxxx', 'https://api.deepseek.com', 'deepseek-chat', 1);
/*!40000 ALTER TABLE `assistant`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `cate`
    DISABLE KEYS */;
INSERT INTO `cate`
VALUES (1, '默认分类', '💻', '/', 'kfbj', 0, 1, 'cate'),
       (67, '首页', '💎', '/', 'home', 0, 0, 'nav'),
       (68, '足迹', '⛳️', '/footprint', 'zj', 83, 9, 'nav'),
       (69, '关于我', '👋', '/my', 'my', 83, 16, 'nav'),
       (70, '朋友圈', '😇', '/friend', 'pyq', 83, 11, 'nav'),
       (71, '留言墙', '💌', '/wall/all', 'wall', 83, 12, 'nav'),
       (72, 'GitHub', '🔥', 'https://github.com/LiuYuYang01/ThriveX-Blog', 'github', 83, 999, 'nav'),
...
/*!40000 ALTER TABLE `comment`
    DISABLE KEYS */;
INSERT INTO `comment`
VALUES (514, '宇阳', 'https://q1.qlogo.cn/g?b=qq&nk=3311118881&s=640', '记得点个star', '3311118881@qq.com',
        'https://liuyuyang.net/', 2187, 0, 0, '1729225111457'),
       (515, 'ThriveX', 'https://q1.qlogo.cn/g?b=qq&nk=3311118881&s=640', '太强了吧', '3311118881@qq.com',
        'https://liuyuyang.net', 2, 0, 1, '1744980488518'),
...
/*!40000 ALTER TABLE `env_config`
    DISABLE KEYS */;
INSERT INTO `env_config`
VALUES (1, 'baidu_statis', '{
  \"site_id\": 0,
  \"access_token\": \"\"
}', '百度统计配置'),
       (2, 'email', '{
...
/*!40000 ALTER TABLE `footprint`
    DISABLE KEYS */;
INSERT INTO `footprint`
VALUES (33, '测试足迹', '测试足迹', '测试足迹', '119.138475,33.6119', '[]', '1599667200000');
/*!40000 ALTER TABLE `footprint`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `link`
    DISABLE KEYS */;
INSERT INTO `link`
VALUES (50, '宇阳', 'ThriveX 博客管理系统作者', 'liuyuyang1024@yeah.net',
        'https://q1.qlogo.cn/g?b=qq&nk=3311118881&s=640', 'https://liuyuyang.net/', 'https://liuyuyang.net/api/rss', 0,
        4, 1, '1723533206613'),
       (52, '这是一个网站', '这是一个网站的描述', 'liuyuyang1024@yeah.net', 'http://127.0.0.1:5000/1.jpg', '/', '/',
        123, 1, 1, '1723533206613'),
       (53, '这是一个网站', '这是一个网站的描述', 'liuyuyang1024@yeah.net', 'http://127.0.0.1:5000/1.jpg', '/', '/',
        123, 1, 1, '1723533206613');
/*!40000 ALTER TABLE `link`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 7
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='网站类型';
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
  ...
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci
  ROW_FORMAT = DYNAMIC COMMENT ='oss配置表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `oss`
    DISABLE KEYS */;
INSERT INTO `oss`
VALUES (1, 'local', NULL, '', '/Users/yang/Desktop/收纳/项目/ThriveX/ThriveX-Server/', NULL, 'localhost:9003/static/',
        'upload/', 1);
/*!40000 ALTER TABLE `oss`
    ENABLE KEYS */;
UNLOCK TABLES;
  ...
  \"project\": [
    ...
    },
    {
      ...
      \"front\": {
        ...
        \"technology\": \"前端：Vue3、TypeScript、Pinia、Element-plus、Scss、Echarts 、highlight.js\"
      },
      \"images\": [
...
(
  ...
  AUTO_INCREMENT = 85
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='角色权限';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (1, 'user:add', '新增用户', 'user'),
       (2, 'user:del', '删除用户', 'user'),
       (3, 'user:edit', '编辑用户', 'user'),
       (4, 'user:info', '获取用户', 'user'),
       (5, 'user:list', '获取用户列表', 'user'),
       (6, 'user:pass', '修改用户密码', 'user'),
       (7, 'data:add', '新增数据', 'data'),
       (8, 'data:del', '删除数据', 'data'),
       (9, 'article:add', '新增文章', 'article'),
       (10, 'article:del', '删除文章', 'article'),
       (11, 'article:reduction', '还原被删除的文章', 'article'),
       (12, 'article:del', '批量删除文章', 'article'),
       (13, 'article:edit', '编辑文章', 'article'),
       (14, 'cate:add', '新增分类', 'cate'),
       (15, 'cate:del', '删除分类', 'cate'),
       (16, 'cate:edit', '编辑分类', 'cate'),
       (17, 'comment:del', '删除评论', 'comment'),
       (18, 'comment:edit', '编辑评论', 'comment'),
       (19, 'comment:audit', '审核评论', 'comment'),
       (22, 'config:edit', '修改项目配置', 'config'),
       (23, 'email:dismiss', '驳回通知邮件', 'email'),
       (24, 'file:info', '获取文件信息', 'file'),
       (25, 'file:dir', '获取目录列表', 'file'),
       (26, 'file:list', '获取文件列表', 'file'),
       (27, 'file:add', '文件上传', 'file'),
       (28, 'file:del', '删除文件', 'file'),
       (29, 'oss:add', '新增oss配置', 'oss'),
       (30, 'oss:del', '删除oss配置', 'oss'),
       (31, 'oss:edit', '更新oss配置', 'oss'),
       (32, 'oss:info', '获取oss配置', 'oss'),
       (33, 'oss:list', '获取oss配置列表', 'oss'),
       (34, 'oss:enable', '启用oss配置', 'oss'),
       (35, 'oss:getEnableOss', '获取当前启用的oss配置', 'oss'),
       (36, 'oss:getPlatform', '获取支持的oss平台', 'oss'),
       (37, 'record:add', '新增说说', 'record'),
       (38, 'record:del', '删除说说', 'record'),
       (39, 'record:edit', '编辑说说', 'record'),
       (40, 'role:add', '新增角色', 'role'),
       (41, 'role:del', '删除角色', 'role'),
       (42, 'role:edit', '编辑角色', 'role'),
       (43, 'role:info', '获取角色', 'role'),
       (44, 'role:list', '获取角色列表', 'role'),
       (46, 'role:bindingRoute', '分配角色权限', 'role'),
       (47, 'route:add', '新增路由', 'route'),
       (48, 'route:del', '删除路由', 'route'),
       (49, 'route:edit', '编辑路由', 'route'),
       (50, 'route:info', '获取路由', 'route'),
       (51, 'route:list', '获取路由列表', 'route'),
       (52, 'swiper:add', '新增轮播图', 'swiper'),
       (53, 'swiper:del', '删除轮播图', 'swiper'),
       (54, 'swiper:edit', '编辑轮播图', 'swiper'),
       (55, 'tag:add', '新增标签', 'tag'),
       (56, 'tag:del', '删除标签', 'tag'),
       (57, 'tag:edit', '编辑标签', 'tag'),
       (58, 'wall:del', '删除留言', 'wall'),
       (59, 'wall:edit', '编辑留言', 'wall'),
       (60, 'wall:audit', '审核留言', 'wall'),
       (62, 'permission:add', '新增权限', 'permission'),
       (63, 'permission:del', '删除权限', 'permission'),
       (64, 'permission:edit', '编辑权限', 'permission'),
       (65, 'permission:info', '获取权限', 'permission'),
       (66, 'permission:list', '获取权限列表', 'permission'),
       (67, 'link:del', '删除网站', 'link'),
       (68, 'link:edit', '编辑网站', 'link'),
       (69, 'link:audit', '审核网站', 'link'),
       (70, 'email:reply_wall', '回复留言', 'email'),
       (71, 'wall:choice', '设置与取消精选留言', 'wall'),
       (72, 'album_cate:add', '新增相册', 'album'),
       (73, 'album_cate:del', '删除相册', 'album'),
       (74, 'album_cate:edit', '编辑相册', 'album'),
       (75, 'album_image:add', '新增照片', 'album'),
       (76, 'album_image:del', '删除照片', 'album'),
       (77, 'album_image:edit', '编辑照片', 'album'),
       (78, 'assistant:add', '新增助手', 'assistant'),
       (79, 'assistant:del', '删除助手', 'assistant'),
       (80, 'assistant:edit', '编辑助手', 'assistant'),
       (81, 'assistant:list', '获取助手列表', 'assistant'),
       (82, 'assistant:default', '设置默认助手', 'assistant'),
       (84, 'config', '编辑配置', 'config');
/*!40000 ALTER TABLE `permission`
    ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `record`
VALUES (1, '测试', '[
  \"https://bu.dusays.com/2024/11/17/6739adf188f64.png\"
]', '1736513670072');
/*!40000 ALTER TABLE `record`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `role`
    DISABLE KEYS */;
INSERT INTO `role`
VALUES (1, '管理员', 'admin', '最高权限'),
       (2, '作者', 'author', '发布文章、查看文章列表');
/*!40000 ALTER TABLE `role`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `route_role`
    DISABLE KEYS */;
INSERT INTO `route_role`
VALUES (1, 1, 5),
       (2, 10, 5),
       (3, 7, 5),
       (4, 9, 5),
...
/*!40000 ALTER TABLE `swiper`
    DISABLE KEYS */;
INSERT INTO `swiper`
VALUES (1, 'ThriveX 3.0 来袭，不忘初心，保持热爱', '', 'https://bu.dusays.com/2025/06/15/684e8f3435c97.png',
        'https://github.com/LiuYuYang01/ThriveX-Admin'),
       (29, 'ThriveX 官网全新发布 🎉', NULL, 'https://bu.dusays.com/2025/01/21/678f4a609f91f.png',
        'https://thrivex.liuyuyang.net/');
/*!40000 ALTER TABLE `swiper`
    ENABLE KEYS */;
UNLOCK TABLES;
...
/*!40000 ALTER TABLE `user`
    DISABLE KEYS */;
INSERT INTO `user`
VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '宇阳', '3311118881@qq.com',
        'https://bu.dusays.com/2024/11/17/6739adf188f64.png', 'ThriveX 博客管理系统作者', '1', '1723533206613');
/*!40000 ALTER TABLE `user`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 80
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='用户 token';
/*!40101 SET character_set_client = @saved_cs_client */;
...
VALUES (79, 1,
        'eyJhbGciOiJIUzI1NiJ9.-mYsyIsImluZm8iOiJUaHJpdmVYIOWNmuWuoueuoeeQhuezu-e7n-S9nOiAhSIsImVtYWlsIjoiMzMxMTExODg4MUBxcS5jb20iLCJhdmF0YXIiOiJodHRwczovL2J1LmR1c2F5cy5jb20vMjAyNC8xMS8xNy82NzM5YWRmMTg4ZjY0LnBuZyIsInJvbGVJZCI6IjEiLCJyb2xlIjpudWxsfX0.1WN9GT1PkSTe4DTlQfnTRjo8HMAWBupEycxklByuJDc');
/*!40000 ALTER TABLE `user_token`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 109
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='留言墙';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `wall`
    DISABLE KEYS */;
INSERT INTO `wall`
VALUES (104, '测试', '测试测试测试测试测试', '#fcafa24d', '3311118881@qq.com', 6, 1, 0, '1729231268305'),
       (107, '测试', '测试测试测试测试测试', '#fcafa24d', '3311118881@qq.com', 6, 0, 0, '1729231268305'),
       (108, '测试', '测试测试测试测试测试', '#fcafa24d', '3311118881@qq.com', 6, 0, 0, '1729231268305');
/*!40000 ALTER TABLE `wall`
    ENABLE KEYS */;
UNLOCK TABLES;
...
(
  ...
  AUTO_INCREMENT = 8
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='留言分类';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `wall_cate`
    DISABLE KEYS */;
INSERT INTO `wall_cate`
VALUES (1, '全部', 'all', 1),
       (2, '想对我说的话', 'info', 2),
       (3, '对我的建议', 'suggest', 3),
       (6, '其他', 'other', 6),
...
(
  ...
  AUTO_INCREMENT = 4
  DEFAULT CHARSET = utf8mb4
  COLLATE = utf8mb4_0900_ai_ci COMMENT ='网站配置';
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!40000 ALTER TABLE `web_config`
    DISABLE KEYS */;
INSERT INTO `web_config`
VALUES (1, 'web', '{
  \"icp\": \"豫ICP备2020031040号-1\",
  \"url\": \"https://liuyuyang.net/\",
  \"title\": \"ThriveX\",
  \"footer\": \"真诚邀请大家成为 ThriveX 博客管理系统的贡献者，一起参与项目开发，构建一个强大的博客管理系统！\",
  \"favicon\": \"https://res.liuyuyang.net/usr/images/favicon.ico\",
  \"keyword\": \"宇阳,刘宇阳,Thrive,前端,Python,Java,Thrive,ThriveX,ThriveX现代化博客管理系统\",
  \"subhead\": \"现代化博客管理系统\",
  \"create_time\": 1547568000000,
  \"description\": \"也许会是最好用的博客管理系统\"
}', '网站配置'),
       (2, 'theme', '{
         \"covers\": [
         ...
         \"social\": [
           {
             \"url\": \"https://github.com/LiuYuYang01\",
             \"name\": \"GitHub\"
           },
           {
         ...
         \"record_info\": \"🎯 梦想做一名技术顶尖的架构师，奈何学历太低！\",
         \"record_name\": \"👋 Liu 宇阳\",
         \"swiper_text\": [
           \"System.out.print(\\\"欢迎使用 ThriveX 博客管理系统！\\\");\",
           \"print(\\\"这是一个 Nextjs + Spring Boot 的产物\\\")\"
         ],
         \"reco_article\": [
           1,
           2
         ],
         \"swiper_image\": \"https://bu.dusays.com/2024/04/24/6628990012b51.jpg\",
         \"right_sidebar\": [
           \"author\",
           \"hotArticle\",
           \"newComments\",
...
-- Dump completed on 2025-08-29 19:56:45
